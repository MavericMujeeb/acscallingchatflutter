...
class DashboardTabletPage extends View {
  final String title;
  int selectedTabIndex = 0;

  DashboardTabletPage({Key? key, required this.title, required this.selectedTabIndex}) : super(key: key);

  @override
  DashboardTabletPageView createState() => DashboardTabletPageView();
}

class DashboardTabletPageView extends ViewState<DashboardTabletPage, DashboardController> {
  DashboardTabletPageView() : super(DashboardController(DataDashboardRepository()));
