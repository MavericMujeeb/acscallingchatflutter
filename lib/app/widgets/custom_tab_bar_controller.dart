...
class CustomTabBarController extends StatefulWidget implements PreferredSizeWidget {
  CustomTabBarController({
    ...
    this.splashColor,
    this.borderWidth = 0,
    this.borderColor = AppColor.black_color,
    this.unselectedBorderColor = AppColor.transparent_color,
...
class _CustomTabBarControllerState extends State<CustomTabBarController>
  ...
  @override
  void didUpdateWidget(CustomTabBarController oldWidget) {
  ...
  Widget _buildButton(
    ...
    final TextStyle? textStyle = TextStyle.lerp(
        widget.unselectedLabelStyle ?? const TextStyle(color: AppColor.black_color),
        widget.labelStyle ?? const TextStyle(color: AppColor.white_color),
        animationValue);
    final Color? borderColor = Color.lerp(
        widget.unselectedBorderColor, widget.borderColor, animationValue);
    final Color foregroundColor = textStyle?.color ?? AppColor.black_color;
            ...
            shape: MaterialStateProperty.all(
              RoundedRectangleBorder(
                side: (widget.borderWidth == 0)
                    ? BorderSide.none
                    : BorderSide(
                  color: borderColor ?? AppColor.black_color,
